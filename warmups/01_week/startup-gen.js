...
// loop thru first Array, save string.  loop thru second Array, save string.
// console log first and second string


// Add each random combo that gets generated into an array. When the array contains 5 random combos, 
// print them out in order with a number prefixing each one e.g.
...
//     console.log('My new great idea is a ' + idea1 + ' for ' + idea2 + '!  Pretty cool, yeah?');
//     listArray.push(idea1 + ' for ' + idea2)
// }
